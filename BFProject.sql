...
--QUERY 6: Number of Credit Problems
select c.customer_id, l.number_credit_problems
from loan.customers c
join loan.loans l ON c.customer_id = l.customer_id
where l.number_credit_problems IS NOT NULL
order by l.number_credit_problems DESC;
...
--QUERY 11: Average Loan Amount by Home Ownership
